    ...
    <div style="margin-top:15vh;">
        ...
        <div class="row align-items-center">
            <div class="input-group mb-4">
                <input id="input-search" name="search" type="text" class="form-control form-control-lg" placeholder="Kokio burtažodžio ieškai?" aria-label="Burtažodžio paieška" aria-describedby="button-search">
